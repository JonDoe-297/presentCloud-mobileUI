...
class DetailViewModel(
    ...
    private val _stateLiveData: MutableLiveData<StuViewState> = MutableLiveData(StuViewState.initial())

    val stateLiveData: LiveData<StuViewState> = _stateLiveData

    fun getCheckinResult(classNum: String, checkinInfoId: String) {
        viewModelScope.launch {
            when (val result = repo.getCheckinResult(classNum, checkinInfoId)) {
